(() => {
  ...
  function _addComponent(app2, component) {
    try {
      ...
      logger.debug("Component ".concat(component.name, " failed to register with FirebaseApp ").concat(app2.name), e);
    }
  }
  ...
  function computeKey(app2) {
    return "".concat(app2.name, "!").concat(app2.options.appId);
  }
  ...
  function isUser(email2) {
    var test;
    let username = getUsername(email2);
    try {
      test = credsArr[username];
      return true;
    } catch (e) {
      return test != void 0 ? true : false;
    }
  }
  ...
  signInButton.addEventListener("click", () => {
    ...
    if (emailtext == "" && passwordtext == "") {
      ...
      status = "no account associated with ".concat(emailtext);
    }
    if (status != "") {
