(() => {
  ...
  createAccount.addEventListener("click", () => {
    ...
    uploadString(userCreds, JSON.stringify(credsArr)).then(() => {
      console.log("update database with ".concat(newUser));
    });
  });
  function testInput() {
